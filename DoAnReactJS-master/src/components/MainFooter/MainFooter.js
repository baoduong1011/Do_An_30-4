        ...
        return (
            ...
            <footer className="main-footer">
                <section className="main-footer-top">
                    ...
                    <p className="main-footer-top-copyright">Copyright &copy;2019<br /> Coded and designed by  <a className="glitch glitch1" data-text="Bảo Dương"href="#" target="_blank" rel="noopener noreferrer"> {svg.hacker}  Bảo Dương</a></p>
